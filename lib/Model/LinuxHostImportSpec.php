...
/**
 * LinuxHostImportSpec Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LinuxHostImportSpec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinuxHostImportSpec';
    ...
    protected static $setters = [
        ...
        'ssh_fingerprint' => 'setSshFingerprint'
    ];
    ...
    protected static $getters = [
        ...
        'ssh_fingerprint' => 'getSshFingerprint'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ssh_fingerprint', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ssh_fingerprint'] === null) {
            $invalidProperties[] = "'ssh_fingerprint' can't be null";
        }
    ...
    /**
     * Gets ssh_fingerprint
     *
     * @return string
     */
    public function getSshFingerprint()
    {
        return $this->container['ssh_fingerprint'];
    }

    /**
     * Sets ssh_fingerprint
     *
     * @param string $ssh_fingerprint SSH key fingerprint used to verify the server identity.
     *
     * @return self
     */
    public function setSshFingerprint($ssh_fingerprint)
    {
        if (is_null($ssh_fingerprint)) {
            throw new \InvalidArgumentException('non-nullable ssh_fingerprint cannot be null');
        }
        $this->container['ssh_fingerprint'] = $ssh_fingerprint;

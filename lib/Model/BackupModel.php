 ...
 */
class BackupModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BackupModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('policy_tag', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the backup.
     *
     * @return self
     */
     ...
     * Sets job_id
     *
     * @param string|null $job_id ID of the job that created the backup.
     *
     * @return self
     */
    ...
    {
        return $this->container['policy_tag'];
    }

    /**
     * Sets policy_tag
     *
     * @param string|null $policy_tag Tag that identifies retention policy.
     *
     * @return self
     */
    public function setPolicyTag($policy_tag)
    {
        if (is_null($policy_tag)) {
            throw new \InvalidArgumentException('non-nullable policy_tag cannot be null');
        }
        $this->container['policy_tag'] = $policy_tag;
     ...
     * Sets name
     *
     * @param string $name Name of the job that created the backup.
     *
     * @return self
     */
     ...
     * Sets platform_id
     *
     * @param string $platform_id ID of the platform of the backup resource.
     *
     * @return self
     */
     ...
     * Sets creation_time
     *
     * @param \DateTime $creation_time Date and time when the backup was created.
     *
     * @return self
     */
     ...
     * Sets repository_id
     *
     * @param string $repository_id ID of the backup repository where the backup is stored.
     *
     * @return self
     */

 ...
 */
class JobsFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobsFilters';
    ...
    protected static $openAPITypes = [
        'skip' => 'int',
        'limit' => 'int',
        'order_column' => '\OpenAPI\Client\Model\EJobFiltersOrderColumn',
        'order_asc' => 'bool',
        'name_filter' => 'string',
    ...
    */
     ...
     * Gets order_column
     *
     * @return \OpenAPI\Client\Model\EJobFiltersOrderColumn|null
     */
     ...
     * Sets order_column
     *
     * @param \OpenAPI\Client\Model\EJobFiltersOrderColumn|null $order_column order_column
     *
     * @return self
     */
     ...
     * Sets name_filter
     *
     * @param string|null $name_filter Filters jobs by the `nameFilter` pattern. The pattern can match any job parameter. To substitute one or more characters, use the asterisk (*) character at the beginning and/or at the end.
     *
     * @return self
     */

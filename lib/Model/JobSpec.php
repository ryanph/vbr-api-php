 ...
 */
class JobSpec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets description
     *
     * @param string $description Job description specified at the time of the job creation.
     *
     * @return self
     */

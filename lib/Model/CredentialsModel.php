 ...
 */
class CredentialsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CredentialsModel';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the credentials record.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Description of the credentials record.
     *
     * @return self
     */
     ...
     * Sets creation_time
     *
     * @param \DateTime $creation_time Date and time when the credentials were created.
     *
     * @return self
     */
     ...
     * Sets tag
     *
     * @param string|null $tag Tag used to identify the credentials record.
     *
     * @return self
     */

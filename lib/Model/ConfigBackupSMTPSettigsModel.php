...
/**
 * ConfigBackupSMTPSettigsModel Class Doc Comment
 *
 * @category Class
 ...
 */
class ConfigBackupSMTPSettigsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfigBackupSMTPSettigsModel';
    ...
    protected static $openAPITypes = [
        'is_enabled' => 'bool',
        'recipients' => 'string[]',
        'settings_type' => '\OpenAPI\Client\Model\EConfigBackupSMTPSettingsType',
        'subject' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('settings_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['settings_type'] === null) {
            $invalidProperties[] = "'settings_type' can't be null";
        }
        ...
        if ($this->container['notify_on_error'] === null) {
            $invalidProperties[] = "'notify_on_error' can't be null";
        }
     ...
     * Sets recipients
     *
     * @param string[] $recipients Array of recipients' email addresses.
     *
     * @return self
     */
     ...
     * Gets settings_type
     *
     * @return \OpenAPI\Client\Model\EConfigBackupSMTPSettingsType
     */
     ...
     * Sets settings_type
     *
     * @param \OpenAPI\Client\Model\EConfigBackupSMTPSettingsType $settings_type settings_type
     *
     * @return self
     */
    public function setSettingsType($settings_type)
    {
        if (is_null($settings_type)) {
            throw new \InvalidArgumentException('non-nullable settings_type cannot be null');
        }
     ...
     * Sets subject
     *
     * @param string $subject Notification subject. Use the following variables in the subject: *%JobResult%*, *%JobName%*, *%Time%* (completion time).
     *
     * @return self
     */
     ...
     *
     * @param bool $notify_on_error If *true*, email notifications are sent when the job fails.
     *
     * @return self
     */

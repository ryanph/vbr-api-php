...
/**
 * CredentialsFilters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CredentialsFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CredentialsFilters';
    ...
    protected static $openAPITypes = [
        'skip' => 'int',
        'limit' => 'int',
        'order_column' => '\OpenAPI\Client\Model\ECredentialsFiltersOrderColumn',
        'order_asc' => 'bool',
        'name_filter' => 'string'
    ];
    ...
    */
     ...
     * Sets skip
     *
     * @param int|null $skip Number of credentials records to skip.
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Maximum number of credentials records to return.
     *
     * @return self
     */
     ...
     * Gets order_column
     *
     * @return \OpenAPI\Client\Model\ECredentialsFiltersOrderColumn|null
     */
     ...
     * Sets order_column
     *
     * @param \OpenAPI\Client\Model\ECredentialsFiltersOrderColumn|null $order_column order_column
     *
     * @return self
     */
     ...
     * Sets order_asc
     *
     * @param bool|null $order_asc Sorts credentials in the ascending order by the `orderColumn` parameter.
     *
     * @return self
     */
     ...
     * Sets name_filter
     *
     * @param string|null $name_filter Filters credentials by the `nameFilter` pattern. The pattern can match any credentials parameter. To substitute one or more characters, use the asterisk (*) character at the beginning and/or at the end.
     *
     * @return self
     */

...
/**
 * ScaleOutRepositoriesFilters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScaleOutRepositoriesFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScaleOutRepositoriesFilters';
    ...
    protected static $openAPITypes = [
        'skip' => 'int',
        'limit' => 'int',
        'order_column' => '\OpenAPI\Client\Model\EScaleOutRepositoryFiltersOrderColumn',
        'order_asc' => 'bool',
        'name_filter' => 'string'
    ];
    ...
    */
     ...
     * Sets skip
     *
     * @param int|null $skip Number of repositories to skip.
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Maximum number of repositories to return.
     *
     * @return self
     */
     ...
     * Gets order_column
     *
     * @return \OpenAPI\Client\Model\EScaleOutRepositoryFiltersOrderColumn|null
     */
     ...
     * Sets order_column
     *
     * @param \OpenAPI\Client\Model\EScaleOutRepositoryFiltersOrderColumn|null $order_column order_column
     *
     * @return self
     */
     ...
     * Sets name_filter
     *
     * @param string|null $name_filter Filters repositories by the `nameFilter` substring. The substring can be part of any repository parameter.
     *
     * @return self
     */

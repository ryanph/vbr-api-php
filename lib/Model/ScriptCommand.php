...
/**
 * ScriptCommand Class Doc Comment
 *
 * @category Class
 ...
 */
class ScriptCommand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScriptCommand';
    ...
    */
     ...
     * Sets is_enabled
     *
     * @param bool $is_enabled If *true*, script execution is enabled.
     *
     * @return self
     */
     ...
     * Sets command
     *
     * @param string|null $command Path to the script.
     *
     * @return self
     */

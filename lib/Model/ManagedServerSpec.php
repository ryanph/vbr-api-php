...
/**
 * ManagedServerSpec Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ManagedServerSpec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedServerSpec';
    ...
    */
     ...
     * Sets credentials_id
     *
     * @param string $credentials_id ID of the credentials used to connect to the server.
     *
     * @return self
     */
     ...
     *
     * @param string|null $certificate_thumbprint [Optional] Certificate thumbprint used to verify the server identity. For details on how to get the thumbprint, see [Get TLS Certificate or SSH Fingerprint](#operation/GetConnectionCertificate).
     *
     * @return self
     */

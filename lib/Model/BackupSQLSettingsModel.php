...
/**
 * BackupSQLSettingsModel Class Doc Comment
 *
 * @category Class
 ...
 */
class BackupSQLSettingsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BackupSQLSettingsModel';
    ...
    protected static $openAPITypes = [
        'logs_processing' => '\OpenAPI\Client\Model\ESQLLogsProcessing',
        'backup_mins_count' => 'int',
        'retain_log_backups' => '\OpenAPI\Client\Model\ERetainLogBackupsType',
        'keep_days_count' => 'int',
        'log_shipping_servers' => '\OpenAPI\Client\Model\BackupLogShippingServersModel'
    ];
    ...
    protected static $attributeMap = [
        'logs_processing' => 'logsProcessing',
    ...
    protected static $setters = [
        'logs_processing' => 'setLogsProcessing',
    ...
    protected static $getters = [
        'logs_processing' => 'getLogsProcessing',
    ...
    {
        $this->setIfExists('logs_processing', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['logs_processing'] === null) {
            $invalidProperties[] = "'logs_processing' can't be null";
        }
    ...
    /**
     * Gets logs_processing
     *
     * @return \OpenAPI\Client\Model\ESQLLogsProcessing
     */
    public function getLogsProcessing()
    {
        return $this->container['logs_processing'];
    }

    /**
     * Sets logs_processing
     *
     * @param \OpenAPI\Client\Model\ESQLLogsProcessing $logs_processing logs_processing
     *
     * @return self
     */
    public function setLogsProcessing($logs_processing)
    {
        if (is_null($logs_processing)) {
            throw new \InvalidArgumentException('non-nullable logs_processing cannot be null');
        }
        $this->container['logs_processing'] = $logs_processing;
     ...
     *
     * @param int|null $backup_mins_count Frequency of transaction log backup, in minutes.
     *
     * @return self
     */
     ...
     *
     * @param int|null $keep_days_count Number of days to keep transaction logs in the backup repository.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\BackupLogShippingServersModel|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BackupLogShippingServersModel|null $log_shipping_servers log_shipping_servers
     *
     * @return self
     */

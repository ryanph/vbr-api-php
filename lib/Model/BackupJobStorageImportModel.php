...
/**
 * BackupJobStorageImportModel Class Doc Comment
 *
 * @category Class
 ...
 */
class BackupJobStorageImportModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BackupJobStorageImportModel';
    ...
    protected static $openAPITypes = [
        'backup_repository' => '\OpenAPI\Client\Model\BackupRepositoryImportModel',
        'backup_proxies' => '\OpenAPI\Client\Model\BackupJobImportProxiesModel',
    ...
    protected static $setters = [
        'backup_repository' => 'setBackupRepository',
    ...
    protected static $getters = [
        'backup_repository' => 'getBackupRepository',
    ...
    {
        $this->setIfExists('backup_repository', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['backup_repository'] === null) {
            $invalidProperties[] = "'backup_repository' can't be null";
        }
    ...
    /**
     * Gets backup_repository
     *
     * @return \OpenAPI\Client\Model\BackupRepositoryImportModel
     */
    public function getBackupRepository()
    {
        return $this->container['backup_repository'];
    }

    /**
     * Sets backup_repository
     *
     * @param \OpenAPI\Client\Model\BackupRepositoryImportModel $backup_repository backup_repository
     *
     * @return self
     */
    public function setBackupRepository($backup_repository)
    {
        if (is_null($backup_repository)) {
            throw new \InvalidArgumentException('non-nullable backup_repository cannot be null');
        }
        $this->container['backup_repository'] = $backup_repository;
     ...
     * Gets backup_proxies
     *
     * @return \OpenAPI\Client\Model\BackupJobImportProxiesModel
     */
     ...
     * Sets backup_proxies
     *
     * @param \OpenAPI\Client\Model\BackupJobImportProxiesModel $backup_proxies backup_proxies
     *
     * @return self
     */

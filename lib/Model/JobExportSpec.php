...
/**
 * JobExportSpec Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JobExportSpec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobExportSpec';
    ...
    */
     ...
     * Sets ids
     *
     * @param string[]|null $ids Array of job IDs.
     *
     * @return self
     */
     ...
     * Sets types
     *
     * @param string[]|null $types Array of job types.
     *
     * @return self
     */
     ...
     * Sets names
     *
     * @param string[]|null $names Array of job names. Wildcard characters are supported.
     *
     * @return self
     */

...
/**
 * BackupOracleSettingsModel Class Doc Comment
 *
 * @category Class
 ...
 */
class BackupOracleSettingsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BackupOracleSettingsModel';
    ...
    */
     ...
     * Sets credentials_id
     *
     * @param string|null $credentials_id ID of the credentials record that is used if `useGuestCredentials` is *false*.
     *
     * @return self
     */

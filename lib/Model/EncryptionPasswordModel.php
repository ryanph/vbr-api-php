...
/**
 * EncryptionPasswordModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EncryptionPasswordModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EncryptionPasswordModel';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the encryption password.
     *
     * @return self
     */
     ...
     * Sets hint
     *
     * @param string $hint Hint for the encryption password.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $modification_time Date and time the password was last modified.
     *
     * @return self
     */

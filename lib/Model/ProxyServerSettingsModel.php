...
/**
 * ProxyServerSettingsModel Class Doc Comment
 *
 * @category Class
 ...
 */
class ProxyServerSettingsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProxyServerSettingsModel';
    ...
    */
     ...
     * Sets host_id
     *
     * @param string $host_id ID of the server.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $failover_to_network [For the Direct storage access and Virtual appliance transport modes] If *true*, Veeam Backup & Replication failovers to the network transport mode in case the primary mode fails or is unavailable.
     *
     * @return self
     */
